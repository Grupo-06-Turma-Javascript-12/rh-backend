...
export class FuncionariosController {
  ...
  @Get('/nome/:nome')
  @HttpCode(HttpStatus.OK)
  findByAllTitulo(@Param('nome') nome: string): Promise<Funcionarios[]> {
    return this.funcionariosService.findByIdTitulo(nome);
  }
  @Post()
  @HttpCode(HttpStatus.CREATED)
  create(@Body() funcionarios: Funcionaarios): Promise<Funcionarios> {
